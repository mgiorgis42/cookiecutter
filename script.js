...
const checkValidity = () => {
    ...
    fulfilled.forEach(e1 => {
        e1.classList.remove('unfulfilled');
        e1.classList.add('fulfilled');
    });
    unfulfilled.forEach(e1 => {
        e1.classList.remove('fulfilled');
        e1.classList.add('unfulfilled');
    });
